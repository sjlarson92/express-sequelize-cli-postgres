    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, sequelize_1.getDbConnection)()];
            case 1:
                sequelize = _a.sent();
            ...
            case 3:
                ...
                return [3 /*break*/, 4];
            case 4:
                app.listen((0, environmentVariables_1.getEnvironmentVariables)().PORT, function () {
                    console.log(">>> Server is running on port: ".concat((0, environmentVariables_1.getEnvironmentVariables)().PORT));
                });
                return [2 /*return*/];
        }
    });
